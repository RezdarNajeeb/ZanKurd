        ...
        while ($currentBooks = mysqli_fetch_assoc($select_current_books)) {
          ...
          <div class='box'>
            <div class="image"> <!-- showing the book image -->
              <a href="book_details.php?id=<?php echo $currentBooks['book_id'] ?>"><img
                  src="uploaded_image/<?php echo $currentBooks['book_image'] ?>" alt=""></a>
            </div>
            ...
            <div class="buttons">
              <?php if (true) { ?>
                ...
                <a href="all_books.php?delete=<?php echo $currentBooks['book_id']; ?>" class="delete-button"
                  onclick="return confirm('Are You Sure?')">سڕینەوە</a>
        ...
        if (mysqli_num_rows($update_query) > 0) {
          while ($fetch_update = mysqli_fetch_assoc($update_query)) {
            ...
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <input type="text" name="update_book_name" value="<?php echo $fetch_update['book_name']; ?>" class="box"
                required placeholder="ناوی کتێب">

              <label for="author">نووسەر</label>
              <input type="text" name="update_author_name" value="<?php echo $fetch_update['author_name']; ?>" class="box"
                required placeholder="ناوی نووسەر">
